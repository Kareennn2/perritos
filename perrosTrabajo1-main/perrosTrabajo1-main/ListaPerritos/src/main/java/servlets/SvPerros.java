...
public class SvPerros extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String fotoFileName = getFileName(filePart);
        if (fotoFileName != null) {
            fotoFileName = new File(fotoFileName).getName(); // Obtener solo el nombre del archivo
        }

        // Ruta para guardar la imagen
        String uploadPath = getServletContext().getRealPath("/data");
        String savePath = uploadPath + File.separator + fotoFileName;
        ...
        Perros perroNuevo = new Perros(nombre, raza, fotoFileName, puntosInt, edadInt);
